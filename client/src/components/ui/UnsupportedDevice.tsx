...
const UnsupportedDevice: React.FC<UnsupportedDeviceProps> = ({ onContinue }) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white shadow-xl rounded-lg p-8 text-center">
        ...
        <div className="bg-blue-50 rounded-md p-4 text-sm text-gray-700 mb-6">
        ...
        <p className="text-xs text-gray-500 mt-3">
          Warning: Some features may not work properly on mobile devices
        </p>
      </div>
    </div>
  );
